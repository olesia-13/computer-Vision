...
#2 читаємо csv файл
df = pd.read_csv('data/figures_twice_extended.csv')
# print(df.head())
...
model = keras.Sequential([
    layers.Dense(16, activation = "relu", input_shape = (4,)), # перший шар - 8 нейронів
    layers.Dense(16, activation = "relu"), # другий шар
    layers.Dense(16, activation = "softmax"), # третій шар
])
...
plt.legend()
plt.savefig('learning_progress_2.png')
plt.show()
